...
int HeadControl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: clicked((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 1: hovered((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 2: hidePoints((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: addPrintedPoint((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        case 4: resetLayer(); break;
        default: ;
        }
        _id -= 5;
    }
