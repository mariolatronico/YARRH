...
**
** Created: Wed 25. Jul 13:38:41 2012
...
""));
        ...
        glWidget = new GlWidget(groupBox_6);
        glWidget->setObjectName(QString::fromUtf8("glWidget"));
        sizePolicy.setHeightForWidth(glWidget->sizePolicy().hasHeightForWidth());
        glWidget->setSizePolicy(sizePolicy);
        gridLayout_7 = new QGridLayout(glWidget);
        gridLayout_7->setSpacing(6);
        gridLayout_7->setContentsMargins(0, 0, 0, 0);
        gridLayout_7->setObjectName(QString::fromUtf8("gridLayout_7"));

        gridLayout_5->addWidget(glWidget, 1, 1, 1, 1);
        ...
        tempGraphWidget = new GraphWidget(graphGroupBox);
        tempGraphWidget->setObjectName(QString::fromUtf8("tempGraphWidget"));
        QSizePolicy sizePolicy4(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy4.setHorizontalStretch(0);
        sizePolicy4.setVerticalStretch(0);
        sizePolicy4.setHeightForWidth(tempGraphWidget->sizePolicy().hasHeightForWidth());
        tempGraphWidget->setSizePolicy(sizePolicy4);
        tempGraphWidget->setMinimumSize(QSize(0, 0));
        ...
        headControlWidget = new HeadControl(widget_9);
        headControlWidget->setObjectName(QString::fromUtf8("headControlWidget"));
        sizePolicy.setHeightForWidth(headControlWidget->sizePolicy().hasHeightForWidth());
        headControlWidget->setSizePolicy(sizePolicy);
